...
namespace Nebulator.Common
{
    ...
    public class Time
    {
        ...
        public Time(int beat, int subdiv)
        {
            if (beat < 0)
            {
                //throw new ArgumentException("Negative value is invalid", nameof(beat));
                beat = 0;
            }
        ...
        public Time(int subdivs)
        {
            if (subdivs < 0)
            {
                throw new ArgumentException("Negative value is invalid", nameof(subdivs));
            }
        ...
        public Time(double tts)
        {
            if (tts < 0)
            {
                throw new ArgumentException($"Negative value is invalid", nameof(tts));
            }
            ...
            {
                throw new ArgumentException($"Invalid subdiv value", nameof(tts));
            }
        }
        #endregion
